...
class _TransferDetailPageState extends State<TransferDetailPage> {
  ...
  Widget build(BuildContext context) {
    Rows _transferHistory = ModalRoute.of(context).settings.arguments;
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: _transferHistory.transferType == "0"
            ? _insideTransfer(_transferHistory)
            : _outsideTransfer(_transferHistory),
      ),
    );
  }

//国际转账
  Widget _outsideTransfer(Rows _transferHistory) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _rowWidget(
              S.of(context).remitter_address, _transferHistory.remitterAddress),
          _rowWidget(
...
//国内转账
  Widget _insideTransfer(Rows _transferHistory) {
    return Container(
      padding: EdgeInsets.fromLTRB(15, 20, 17, 15),
      child: Column(
        mainAxisSize: MainAxisSize.min,
