...
class CustomPopupWindowButton<T> extends StatefulWidget {
  ...
  @override
  _CustomPopupWindowButtonState createState() {
    return _CustomPopupWindowButtonState();
  }
...
class _CustomPopupWindowButtonState<T> extends State<CustomPopupWindowButton> {
...
class _PopupWindowScope extends InheritedWidget {
  ...
  final _CustomPopupWindowButtonState state;
