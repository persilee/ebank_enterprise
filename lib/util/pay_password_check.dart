...
Future<String> CheckPayPassword(BuildContext context, VoidCallback callback) {
...
Future<String> _openBottomSheet(
  ...
  if (!passwordEnabled) {
    ...
    // 输入交易密码
    String password = await _didBottomSheet(context);
    // 如果交易密码正确，处理审批逻辑
...
//交易密码窗口
Future<String> _didBottomSheet(BuildContext context) async {
  String passwordStr = '';
