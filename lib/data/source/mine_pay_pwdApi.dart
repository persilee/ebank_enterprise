...
class PaymentPwdRepository {
  //修改支付密码
  Future<SetPaymentPwdResp> updateTransPassword(SetPaymentPwdReq req, String tag) {
    return request(
      'cust/user/updateTransPassword', req, tag, (data) => SetPaymentPwdResp.fromJson(data));
  }
