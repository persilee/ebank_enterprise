...
class NeedToBeDealtWithRepository {
  ...
  //我的待办详情
  Future<ProcessTaskResp> getMyProcessTask(GetProcessTaskReq req, String tag) {
    return request('/firmWkfl/processTask/completeTask', req, tag,
        (data) => ProcessTaskResp.fromJson(data));
  }
