...
//简体中文 繁体中文 英文
@property (nonatomic, assign)SELanguageType languageType;//不能为空
//AI话术ID
@property (nonatomic, copy)NSString * code;//不能为空
@property (nonatomic, copy)NSString * errAIcode;//不能为空
...
@property (nonatomic, copy)NSString *tenantName;//水印标签(公司名字)

@property (nonatomic, assign)SECertificateType certificateType;//证件识别必填证件类型
